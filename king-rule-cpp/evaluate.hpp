...
namespace Evaluate {
    ...
    inline static void apply_bonus(Eval* eval, Eval bonus);
    
    inline static void set_file_occupied(FileData* data, int file, bool occupied);
    inline static void set_square_backwards(SquareData* data, Square square, bool backwards);
    inline static bool get_file_occupied(FileData* data, int file);
    inline static bool get_square_backwards(SquareData* data, Square square);
